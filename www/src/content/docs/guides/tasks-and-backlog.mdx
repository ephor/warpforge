...
Active work across every project lives in four tabs — **Live**, **Needs you**, **Failed**, and **Pinned** — with full-width live rows, inline queue actions, and the tab you were last on remembered. It's a triage screen: the point is answering *what needs me right now* without opening anything.
