...
- **The work is repeatable.** Pipelines are versioned YAML in `.warpforge/workflows/`, so the process travels with the repo instead of living in one person's habits.
