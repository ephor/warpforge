...
describe("activeThinkingIndex", () => {
  ...
  it("ends a thought phase on tools, answers, and turn boundaries", () => {
    ...
    expect(activeThinkingIndex([thought, tool], "running")).toBeNull();
    expect(
  ...
  it("uses raw chronology when a repeated tool frame completes after thinking", () => {
